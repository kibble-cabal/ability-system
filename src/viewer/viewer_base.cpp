...
void AbilitySystemViewerBase::_bind_methods() {
    ...
    ClassDB::bind_method(
        D_METHOD("_abilities_changed"),
        &AbilitySystemViewerBase::_abilities_changed
    );
    ClassDB::bind_method(
...
void AbilitySystemViewerBase::connect_all() {
    ...
    if (ability_system != nullptr) {
        ...
        try_connect(
            ability_system,
            as_signal::AbilitiesChanged,
            callable_mp(this, &AbilitySystemViewerBase::_abilities_changed)
        );
        try_connect(
            ability_system,
            as_signal::AttributesChanged,
            callable_mp(this, &AbilitySystemViewerBase::_attributes_changed)
        );
        try_connect(
            ability_system,
            as_signal::TagsChanged,
            callable_mp(this, &AbilitySystemViewerBase::_tags_changed)
        );
        try_connect(
            ability_system,
            as_signal::EventsChanged,
            callable_mp(this, &AbilitySystemViewerBase::_events_changed)
        );
        try_connect(
            ability_system,
            as_signal::EffectsChanged,
            callable_mp(this, &AbilitySystemViewerBase::_effects_changed)
        );
        try_connect(
            ability_system,
            as_signal::EventBlocked,
            callable_mp(this, &AbilitySystemViewerBase::_event_blocked)
        );
        connect_to_tags();

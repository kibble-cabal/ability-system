...
protected:
    ...
    /// @brief Connects all existing tags to prompt a redraw when any property
    /// is changed.
    void connect_to_tags();

    /// @brief Connects all existing attributes to prompt a redraw when any
    /// property is changed.
    void connect_to_attributes();

    /// @brief Connects all existing abilities to prompt a redraw when any
    /// property is changed.
    void connect_to_abilities();

    /// @brief Connects all existing ability events to prompt a redraw when any
    /// property is changed.
